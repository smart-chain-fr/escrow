...
class EscrowContractTest(TestCase):
    ...
    def test_add_comment(self):
        ...
        self.assertEqual(comment_broker.storage["escrows"][escrow_key]["comment"], {(200,3): escrow_comment["message"]}) 
        self.assertEqual(comment_seller.storage["escrows"][escrow_key]["comment"], {(200,2): escrow_comment["message"]}) 
